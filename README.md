...
- 611 questions extracted from `NEW-SY0-701-611Q.pdf`
- 605 auto-gradable multiple-choice questions
- 6 PDF Hotspot/Simulation or missing-answer items kept as review-only cards
...
- `A` to `H`: select answer
- `Enter`: check answer
- `ArrowLeft` / `ArrowRight`: previous or next question
